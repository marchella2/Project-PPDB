...
if(isset($_POST['login'])){
    $sql = mysqli_query($konek, "SELECT * FROM tb_admin WHERE username='$_POST[username]' and password='$_POST[password]'");
    $cek = mysqli_num_rows($sql);
    if($cek>0){
		$_SESSION['username']=$_POST['username'];
        echo "<script>alert('Berhasil Login');document.location.href='dashboard.php'</script>";
    }else{
